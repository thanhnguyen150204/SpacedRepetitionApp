          ...
          <div className="modal-overlay" onClick={() => setSelectedDeckModal(null)}>
            <div className="modal animate-up" onClick={e => e.stopPropagation()} style={{ maxWidth: 480 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                ...
                >
                  <div style={{ width: 44, height: 44, borderRadius: 12, background: 'rgba(13,148,136,0.12)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--teal)', flexShrink: 0 }}>
                    <Keyboard size={22} />
                  </div>
                  <div>
                    <div style={{ fontWeight: 700, fontSize: 15 }}>Luyện gõ từ vựng</div>
                    <div style={{ fontSize: 12, color: 'var(--text-muted)', marginTop: 2 }}>Gõ từ theo nghĩa, kiểm tra từng chữ cái đúng/sai</div>
                  </div>
                </Link>
